...
**1. 音はホログラフィックであり、文字は離散的である。**

音楽や文を聴くとき、受け取るのは音高・音色・リズム・強勢・声調の総和であり、全体的で三次元的な知覚です。脳がそれを分解する必要はなく、直観だけでそれが悲しい、軽快、怒りなどを即座に教えてくれます。しかし、その感覚を「書き」表そうとした瞬間、連続的な音波を静的で線形的な記号に切り分けざるを得ません。ホログラフィックな全体から線形的な記号へと移す過程で、情報の 90% が必然的に失われます。

**2. 直観は瞬時であり、論理は遅れてやってくる。**

slither という単語を聴くと、舌が歯に擦れる摩擦音が、瞬時に「ぬるぬる、滑る」という身体的連想を呼び起こします。しかし「なぜ sl が滑るを連想させるか」を書き言葉で説明しようとすれば、発声器官の働きと気流を解剖しなければなりません。説明が終わる頃には、その瞬時の「美」と「直観」はとうに消え去っています。

それでも本節は、音と意味の関係を文字だけで描写しようと試みますが、必然的に難解で説得力に欠けるものになります — しかし本書にも他に方法はありません。音と意味の関係を真に理解するには、最も直接的で効果的な方法は、ただ繰り返し聴き、話すことです。
...
例えば、good, great, God などの主要文字は G です。だから私たちは文字 G が「善」の感覚を担うことを知ります。同様に、home, house, hold, have, help から、文字 H が「保つ・守る」の意味を持つことを知り、light, relate, lace, line, long から、文字 L が「線とつながり」の意味を持つことを知ります。しかし、これは「直観的に体得できるが言葉では表せない」奥深い洞察であり、主要文字のニュアンスは読者が学習の過程で次第に体得していくものです。
...
以下は大まかな文字による描写にすぎず、直感的に体得するのみで、規則のまとめではありません。
