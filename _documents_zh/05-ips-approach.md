...
大多数单词的发音都符合开音节与闭音节规则，但少数单词不符合，如have, change, waste, taste等，记忆时，注意区分。其规则如表2所示：
...
|---|---|---|
| 开音节 | 元音结尾 | we, go |
|  | 元音字母+辅音字母¹ + 不发音e结尾（或y结尾） | name，lady |
|  | 元音字母+元音字母+辅音² | wait, meet |
| 闭音节 | 元音字母+辅音字母结尾 | net |
|  | 元音字母+两辅音字母+不发音e结尾 | solve |

¹ 可将th，st，ng组合看成一个辅音字母，这样bathe, change, waste, taste等就满足开闭音规则了。

² 此条规则的元音字母组合见元音发音表，其中R, W, Y要与辅音字母区别对待，因为R为翘舌，相当于长音，W通U，Y通I。而[èa]音可当成一个元音字母对待。

不发音的辅音字母在开闭音节规则中，视为没有此辅音字母。

## 基本元音

五个元音字母为A, E, I, O, U；以及三个半元音字母Y、R和W。此8个字母构成了元音的所有发音，表为元音字母基本发音表，这些发音是最规则，也是最常用的发音。务必熟记表中内容。
...
³ 开音节中，u在[j], [l], [r], [sh]，[s̃], [y]后发blue中的u音，其余情况发duty中的u音,即在[ū]音前加[y]音，即[yū]音；[ū]音在[l],[r],[sh],[ch],[s̃]前时，发短音[ù]，如：在bull, full, pull, push组合中。
...
相比于清晰、准确的开音和闭音这样的重音，弱音便是随意、模糊、放松。如果说开音和闭音是重要音节，那么弱音便是不重要音节。弱读存的意义便在于省力、休息、过渡、流畅。长弱音和短弱音都是弱音。长弱指的是，由于-r字母（当r后为辅音时）使弱音拉长，这便使得原来的弱音具有了像开音一样的长音。短弱指的是，没有-r字母，或者-r-字母后紧跟其他元音（单词末尾不发音e也算作元音，如culture），此时r字母成为与其后元音拼读的辅音字母。

### 轻音说明：

轻音比重音要弱一点，又比弱音要重一点，轻音既可看作重音也可作弱音。

## 重弱交替

"重"与"弱"是一组相对的概念，也就是说，一个音碰上比自己重的音，则自己便为弱音；碰上比自己弱的音，则自己便为重音。表所示为元音重弱顺序表。

一个单词通常只有一个至两个音节重读，其余均为弱读。前缀和后缀常发弱音，发音较为固定。
...
英语单词的发音规则，归纳为四个字"重、弱、开、闭"。"重"指重读，"弱"指弱读，"开"指开音节，"闭"指闭音节。

通过对所有单词的考查，多数的单词（80%以上）都是符合重弱交替、开闭音规则的。在记忆单词时，首先明确单词的重音音节，根据"重弱交替"的规则确定弱读的音节，然后确定重音是开音，还是闭音。

对于不符合一般发音规范的个别音节，在记忆时专门留心，便可以显著提高记忆效率。

## 全部元音

在基本元音表的基础上进行扩展，便形成了表。
...
流音指的是字母R和字母L所发的音。这两个字母之所以特殊在于它们的发音特点：它们易于与辅音和元音结合。
...
如：[ōr]、[ōar]、[ōur]音，因受流音R的影响，听起来像[or]（[o]音的拉长）。如pore, board。

[ār]，[āir]，[āer]，[eār]音，因受流音R的影响，听起来像[er]音。如care, air, bear。

### 长音短化

长音短化指的是：长元音后紧跟流音[l]、[r]或弱音，由于受其影响，使原有长音听起来像短音。

由于流音[l]、[r]和弱音本身便具有拉长作用，所以当它们与长元音结合时，长元音自然短化，以使得整个音节发音不致过长。

### 流音与辅音结合

从辅音组合表中，可以看出，其中有很多流音L和R与辅音结合的例子。

## 元音字母窜位

元音字母窜位：指的是其他的元音字母取代规则发音的元音字母起发音作用。

表为元音窜位表，元音字母窜位的主要情况为：E字母窜A字母，I字母窜E字母，A字母窜O字母，O字母窜U字母。

元音字母窜位的原因主要有两个方面：1. 单词读音发生了变化，但字形没有跟着发生变化；2.外来词。

**元音字母窜位情况表**

| 元音字母 | 窜位情况 | 例词 |
|---|---|---|
| E窜A | èy, èi | they, eight |
| I窜E | ĩ | ski, police |
| A窜O | ã(l),ãu,ãw,ãr, | all, auto, law, war |
| O窜U | ô,ôu, ôo / oo,õ | love, double, blood, book, do |
...
以下是常用的辅音组合，辅音组合与辅音一样都带有某些原始的内涵，这些内涵不可言状，学习者在记忆大量英语单词后，便能体会出。比如fl-有流动、飞、松弛等内涵，fr-有裂开、冷、磨损等内涵，tw-有扭曲等内涵。如表4所示：
...
| judgement | judgment | dg发[j]，可以去掉字母e |
| acknowledgement | acknowledgment | dg发[j]，可以去掉字母e |
| honour | honor | 去掉多余字母 |
| labour | labor | 去掉多余字母 |
...
| centre | center | 用-er代替-re |
| fibre | fiber | 用-er代替-re |
| metre | meter | 用-er代替-re |
| theatre | theater | 用-er代替-re |
| defence | defense/defence | 二者都行 |
| offence | offense/offence | 二者都行 |
| licence | license/licence | 二者都行 |
| pretence | pretense/pretense | 二者都行 |
| you/your | u / ur | 网络用语，节省打字时间 |
...
4）英语通常"一弱到底"，美语词尾起还会发重音，更加符合"重弱交替"规则。
