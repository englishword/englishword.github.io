...
**音形标注（IPS notation）** 属于一种直注式音标，在不改变单词拼写的情况下，通过在单词元音字母，以及少数辅音字母上方标注符号区别单词不同读音，在简明性上优于国际音标符号（IPA symbols）和其他重拼符号（Respelling symbols）。

音形意统一记忆法将单词主要元音发音由"重"到"弱"分为四个节奏：开音节、闭音节、轻音节和弱音节。开音节标横线（─），闭音节不标（∅），轻音节标圆点（⦁），弱音节标圆圈（○）。
...
*注：为了有效区分多音，又引入了三个符号波浪（∼）、长捺（∖）和尖角（∧），以作区分。*
...
|---|---|---|---|---|---|
| 举例 | hāir | weār | bēer | hēar | |
| | [ ōar ] = [ or ] | [ ōur ] = [ or ] | [ eūr ] | | |
| 举例 | bōar | fōur | Eūro̊pe | | |
