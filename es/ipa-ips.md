...
title: IPA&amp;IPS
layout: ipa-ips
description: Comparación de IPA e IPS
---

El Alfabeto Fonético Internacional (IPA) frente a la notación IPS utilizada en este método. La notación IPS se muestra entre `[ ]`, la IPA entre `/ /`. La clave para memorizar las palabras inglesas es conocer esta tabla de memoria y pronunciar cada palabra con precisión.

## Tabla de comparación IPA e IPS

| IPA | Notación IPS | IPA | Notación IPS |
|---|---|---|---|
...
> Nota: Los símbolos IPA marcados en <font color="red">rojo</font> en la tabla anterior son símbolos adicionales inventados por la IPA; IPS no inventa caracteres nuevos: el sonido y la ortografía están unificados.
