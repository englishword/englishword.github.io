...
title: IPA&amp;IPS
layout: ipa-ips
description: Сравнение IPA и IPS
---

Международный фонетический алфавит (IPA) в сравнении с нотацией IPS, используемой в данном методе. Нотация IPS заключается в `[ ]`, а IPA — в `/ /`. Ключ к запоминанию английских слов — выучить эту таблицу наизусть и точно произносить каждое слово.

## Таблица сравнения IPA и IPS

| IPA | Нотация IPS | IPA | Нотация IPS |
|---|---|---|---|
...
> Примечание: символы IPA, отмеченные <font color="red">красным</font> в таблице выше, — это дополнительные знаки, изобретённые IPA; IPS не изобретает новых символов — звук и форма едины.
