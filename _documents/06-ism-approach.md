---
title: "ISM — Integrated Spelling & Meaning"
weight: 6
---
...
**Table 15 — Prefixes and Their Variant Rules**

| Prefix | Variant | Meaning |
|---|---|---|
| in- | becomes il-, ir-, i- before l, r, gn<br>becomes im- before b, m, p | in, not |
| ad- | assimilates to ab, af, ag, al, an,<br>ap, ar, as, at before b, f, g, l, n, p, r, s, t<br>becomes ac- before c, k, q | away, not, intensive |
| con- | becomes co- before h, gn, and vowels<br>becomes col- before l<br>becomes cor- before r<br>becomes com- before b, m, p | together |
| en- | becomes em- before b, m, p | in, intensive |
| ex- | becomes ef- before f<br>becomes e- before b, c, d, g, j, l, m, n, r, v<br>extra-, exo- | out |
| ob- | becomes oc-, of-, op- before c, f, p | against |
| syn- | becomes sym- before b, m, p<br>becomes syl-, syr- before l, r<br>becomes sy- before s, z<br>drops n before vowels | same |
| sub- | becomes suc-, suf-, sug-, sum-, sup-, sur- before c, f, g, m, p, r | under |
| a- | becomes an- before vowels or consonant h | not, intensive |
| ne- | becomes n- before vowels<br>becomes neg- before roots beginning with l | not |
| per- | becomes pel- before l. | through, all |
| dis- | becomes dif- before f. | away, not |
...
| Nine | Ten | Half | Many | Hundred | Thousand | Micro | Macro |
|---|---|---|---|---|---|---|---|
...
Common suffixes are classified below by part of speech to aid memorization. The suffixes listed here are commonly used ones.

Common suffixes classified by part of speech:

- Nouns
  - People, things: ain, aire, an, i-an, ant, ar, ard, art, ary, ate, at-or, ee, eer, en, enne, ent, er, ese, ess, eur, fi-er, herd, ic-i-an, ier, ist, ist-er, ite, it-or, ive, log-ist, man, on, or, our, ster, y, yer
  - Abstract nouns: abili-ty, ibi-li-ty, ace, acy, aci-ty, ac-le, ade, age, al, al-ity, ance, ancy, ane-i-ty, ary, ari-an, at-ion, ence, ency, e-th, cy, dom, f-ic-at-ion, hood, ia, ic(s), ice, i-li-ty, ise, ing, (s/t)ion, ism, asm, it-ion, itude, iv-ity, iz-at-ion, logy, (i)um, ment, mony, ness, our, or, os-i-ty, ry, ship, th, ty, ety, ity, ure, y
  - Places: ace, age, ary, dom, ery, ory, ari-um, ori-um, um, y
  - Small things (diminutives): cle, el, le, en, in, et, ette, kin, let, ling, ule, ie, y
- Adjectives
...
When a root ending in a consonant is joined to a suffix beginning with a consonant, the lack of a vowel prevents smooth pronunciation, so a combining vowel — -a-, -e-, -i-, -o-, or -u- — is often inserted to serve as a link. The use of these combining vowels is fairly arbitrary and follows no rule. Some roots are regularly followed by a fixed combining vowel, which may be regarded as part of the root for memorization, such as the -i- in the root agri-. Sometimes a combining vowel is merged with a suffix; for example, in artificial, the most complete segmentation is art-i-f-ic-i-al (art is the root; the first and third i are combining vowels; f is the form taken by fy after changing to fi and dropping i), though it is usually segmented only as art-if-ic-ial. Another example is institution, whose most complete segmentation is in-stit-u-t-i-on (in is the prefix; stit is the root; u and i are combining vowels; on is the suffix), though it is usually segmented as in-stit-ut-ion, in-stitu-tion, in-stitut-ion, or in-stit-u-tion, according to personal preference.

When memorizing words, take care to distinguish the combining vowels from the rest of the word and give them due attention; this makes misspelling less likely.

## Suffix Variation

Most students know to add -ly to an adjective to form an adverb; to add -ing and -ed to a verb to change its tense; and to add -er and -est to an adjective to form the comparative and superlative. But most students do not know how to use other suffixes, or have not fully and systematically mastered the use of all suffixes and their variations. In fact, suffix variation seems complicated but is actually quite simple — it is all a combination of the following three rules and the five combining vowels.
...
Doubable consonant letters: B, C, D, F, G, L, M, N, P, R, S, T, Z. Non-doubable consonant letters: H, J, K, Q, V, W, X, Y.
In words beginning with qu, the u is pronounced [w] and is treated as a consonant; for example, quitting doubles the t.

The consonant letter C may be doubled as cc or ck depending on the vowel letter that follows.
...
Morphemes are composed of vowel phonemes and consonant phonemes. Since prefixes and suffixes are fewer in number than roots, we can analyze their vowel and consonant composition. As the analysis shows, the common compositions of prefixes and suffixes are given in Table 19; memorizing this table effectively helps one master prefixes and suffixes.

**Table 19 — Common Combinations of Prefixes and Suffixes**
